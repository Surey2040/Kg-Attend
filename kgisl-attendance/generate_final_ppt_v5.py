...
prs.save(r'c:\Users\surreyy\Desktop\presenceIQ\PresenceIQ_MCA_Review1_Final_v5.pptx')
print("Successfully modified PresenceIQ_MCA_Review1_Final_v5.pptx (15 slides) - Recreated 13-stage visual pipeline.")
